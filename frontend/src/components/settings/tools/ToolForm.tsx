    ...
    switch (fieldSchema.type) {
        ...
        return (
          <div key={key} className="space-y-3">
            ...
            <Input
              ...
              value={value}
              onChange={(e) => handleConfigChange(key, e.target.value)}
              placeholder={t("tools.enter_placeholder", "Enter {{field}}", {
                field: label,
              })}
              required={required}
            />
      ...
      case "boolean":
        return (
          <div
            key={key}
            className="flex items-center justify-between p-4 border rounded-lg bg-slate-50/50 dark:bg-slate-800/50"
          >
          ...
          return (
            <div key={key} className="space-y-3">
              <Label
                ...
                className="text-sm font-medium flex items-center gap-2"
              >
                {t("tools.fields.headers", "Headers")}{" "}
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-muted-foreground mb-6">
            The tool youre looking for doesnt exist or has been deleted.
          </p>
          <Button
            variant="outline"
          ...
          <div>
            <h1 className="text-2xl font-bold">
              {mode === "create"
                ...
                : t("tools.edit_title", "Edit Tool")}
            </h1>
            <p className="text-lg text-muted-foreground">
              {mode === "create"
                ? t(
                    "tools.create_description",
                    "Create a new tool for your AI assistants."
                  )
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      {t("tools.display_name", "Display Name")}{" "}
                      <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      id="display_name"
                      ...
                      placeholder={t(
                        "tools.display_name_placeholder",
                        "My API Tool"
                      )}
                      required
                    />
                ...
                <div className="space-y-3">
                  <Label htmlFor="description" className="text-sm font-medium">
                    {t("tools.description_field", "Description")}{" "}
                    <span className="text-red-500">*</span>
                  </Label>
                  <Textarea
                    id="description"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-8">
                  ...
                  {schema?.properties && (
                    <div>
                      <div className="mb-6">
                        ...
                        <p className="text-muted-foreground">
                          {t(
                            "tools.configuration_description",
                            "Configure the parameters for your tool."
                          )}
                        </p>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        {/* JQ Query Section - Only for API tools */}
                        {formData.type === "api" && (
                          <div>
                            <div className="space-y-3">
                              <Label
                                ...
                                className="text-sm font-medium"
                              >
                                {t("tools.jq_query_label", "JQ Query")}
                              </Label>
                              <Textarea
                                id="jq_query"
                                value={formData.config?.jq_query || ""}
                                onChange={(e) =>
                                  handleConfigChange("jq_query", e.target.value)
                                }
                                rows={4}
                                placeholder={t(
                                  "tools.jq_query_placeholder",
                                  "e.g., .data, .[] | select(.active == true), {results: .items, count: (.items | length)}"
                                )}
                              ...
                              <p className="text-xs text-muted-foreground">
                                {t(
                                  "tools.jq_query_help",
                                  "Leave empty to return the raw API response. Use jq syntax for filtering and transformation."
                                )}
                              </p>
                            </div>
                          </div>
                  ...
                  <div>
                    <div className="mb-6">
                      ...
                      <p className="text-muted-foreground">
                        {t(
                          "tools.parameters_description",
                          "Define the parameters that will be passed to this tool when executed."
                        )}
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      {formData.parameters.map((param, index) => (
                        <div
                          key={index}
                          className="border rounded-lg p-4 bg-slate-50/50 dark:bg-slate-800/50"
                        >
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                              <Label className="text-sm font-medium">
                                {t("tools.param_name", "Name")}{" "}
                                <span className="text-red-500">*</span>
                              </Label>
                              <Input
                                value={param.name}
                              ...
                              >
                                ...
                                <SelectContent>
                                  <SelectItem value="string">
                                    {t("tools.types.string", "String")}
                                  </SelectItem>
                                  <SelectItem value="number">
                                    {t("tools.types.number", "Number")}
                                  </SelectItem>
                                  <SelectItem value="integer">
                                    {t("tools.types.integer", "Integer")}
                                  </SelectItem>
                                  <SelectItem value="boolean">
                                    {t("tools.types.boolean", "Boolean")}
                                  </SelectItem>
                                  <SelectItem value="object">
                                    {t("tools.types.object", "Object")}
                                  </SelectItem>
                                  <SelectItem value="array">
                                    {t("tools.types.array", "Array")}
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                            </div>
                ...
                <div className="flex justify-end gap-4 pt-8 ">
                  ...
                  <Button type="submit" disabled={isLoading}>
                    ...
                    {isLoading
                      ? mode === "create"
                        ? t("tools.creating", "Creating...")
                        : t("tools.updating", "Updating...")
                      : mode === "create"
                        ? t("tools.create", "Create")
